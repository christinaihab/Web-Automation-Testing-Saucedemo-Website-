package com.demo.utils.dataReader;
...
public class PropertyReader {
    ...
    public static Properties loadProperties() {
        try {
            ...
            propertiesFiles = FileUtils.listFiles(new File("src/test/resources"), new String[]{"properties"}, true);            propertiesFiles.forEach(file -> {
                try {
